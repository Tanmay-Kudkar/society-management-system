...
public class SocietyServiceImpl implements SocietyService {
    ...
    public SocietyResponse create(SocietyRequest request) {
        ...
        ensureAutoGeneratedWings(saved);
    ...
    private void mapRequestToEntity(SocietyRequest request, Society society) {
        ...
        society.setTotalFloors(request.getTotalFloors() != null ? request.getTotalFloors() : 1);
    ...
    private SocietyResponse toResponse(Society society) {
        ...
        response.setTotalFloors(society.getTotalFloors());
    ...
    private void ensureAutoGeneratedWings(Society society) {
        ...
        for (int i = 0; i < totalWings; i++) {
            String expectedWingName = String.valueOf((char) ('A' + i));
            if (existingNames.contains(expectedWingName)) {
                continue;
            }

            Wing wing = new Wing();
            wing.setSociety(society);
            wing.setName(expectedWingName);
            wing.setTotalFloors(totalFloors);
            wingRepository.save(wing);
            existingNames.add(expectedWingName);
        }
    }
