    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage housing societies</p>
        </div>
        <button
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredSocieties.map((society) => (
            <div key={society.id} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">{society.name}</h3>
              <p className="text-sm text-gray-600 mb-4">{society.address}</p>
              <div className="space-y-1 text-sm">
                <p className="text-gray-500">
                  <span className="font-medium text-gray-700">City:</span> {society.city}
                </p>
                <p className="text-gray-500">
                  <span className="font-medium text-gray-700">Phone:</span> {society.phone || '-'}
                </p>
                <p className="text-gray-500">
                  <span className="font-medium text-gray-700">Reg No:</span> {society.registrationNumber || '-'}
                </p>
              </div>
            </div>
          ))}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between p-4 border-b border-gray-100 sticky top-0 bg-white">
              <h3 className="text-lg font-semibold">{editingSociety ? 'Edit Society' : 'Add Society'}</h3>
