    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage resident complaints</p>
        </div>
        <button
      ...
      {isLoading ? (
        ...
        <div className="space-y-4">
          {filteredComplaints.map((complaint) => {
            ...
            return (
              <div key={complaint.id} className="bg-white rounded-xl shadow-sm border border-gray-100 p-5 hover:shadow-md transition">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <div className="flex items-center gap-2 flex-wrap">
                        <span className="text-sm font-mono text-gray-500">{complaint.complaintNumber}</span>
                        <span className={clsx('px-2 py-0.5 rounded-full text-xs font-medium', statusColors[complaint.status])}>
                          {complaint.status?.replace('_', ' ')}
                        </span>
                        <span className="px-2 py-0.5 bg-gray-100 text-gray-700 text-xs rounded-full">{complaint.category}</span>
                      </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-lg">
            <div className="flex items-center justify-between p-4 border-b border-gray-100">
              <h3 className="text-lg font-semibold">Log Complaint</h3>
            ...
            <form onSubmit={handleSubmit} className="p-4 space-y-4">
              ...
              <div>
                ...
                <input type="text" name="subject" required className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none" />
              </div>
              <div>
              ...
              <div>
                ...
                <textarea name="description" rows={4} required className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none" />
              </div>
