...
export const AuthProvider = ({ children }) => {
  ...
  const canManageNotices = useCallback(() => hasPermissionRole('SOCIETY_ADMIN', 'CHAIRMAN', 'SECRETARY', 'TREASURER'), [hasPermissionRole])
  ...
  const canManageUsers = useCallback(() => hasPermissionRole('SOCIETY_ADMIN', 'CHAIRMAN', 'SECRETARY', 'TREASURER', 'COMMITTEE', 'MEMBER'), [hasPermissionRole])
  ...
  const canManageVehicles = useCallback(() => hasPermissionRole('SOCIETY_ADMIN', 'CHAIRMAN', 'SECRETARY', 'TREASURER', 'COMMITTEE', 'MANAGER'), [hasPermissionRole])
