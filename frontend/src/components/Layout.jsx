  ...
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)]">
      ...
      <header className="fixed inset-x-0 top-0 z-40 lg:left-[272px]">
        <div className="h-14 sm:h-16 border-b border-[var(--border-default)] bg-[var(--bg-secondary)] backdrop-blur-[8px]">
          <div className="mx-auto flex h-full max-w-[1800px] items-center justify-between gap-4 px-4 lg:justify-end lg:px-6 [&>*]:min-w-0">
            ...
            <div className="group flex cursor-pointer items-center gap-3 text-decoration-none lg:hidden" onClick={() => navigate(resolvePath("/"))}>
              <div className="rounded-lg bg-[var(--accent-primary)] p-1.5 sm:p-2 shadow-[0_2px_6px_rgba(47,129,247,0.2)] transition-transform duration-200 group-hover:scale-[1.04]">
                <Building2 size={22} className="text-white" />
              </div>
              <div className="flex flex-col">
                <span className="text-[18px] sm:text-[20px] font-extrabold tracking-[-0.02em] text-[var(--text-primary)]">SocietyHub</span>
